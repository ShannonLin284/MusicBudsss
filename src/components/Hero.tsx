  ...
  const sampleProfiles = [
    {
      ...
      bio: "Indie pop enthusiast looking for concert buddies! Love discovering new artists and singing along to every word.",
    ...
    },
    {
      ...
      bio: "Hip-hop head and festival lover. Always down for a good show and meeting new people who share the vibe.",
      ...
      <div className="max-w-md mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Swipe right to connect with music lovers
          </p>
        </div>
